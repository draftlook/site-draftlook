...
<div class = "tableclass">
  <table>
    ...
    <tr>
      <td class="num">`r format(round(player_data$goals/player_data$games_played,2), nsmall=2)`</td>
      <td class="num">`r format(round(player_data$assists/player_data$games_played,2), nsmall=2)`</td>
      <td class="num">`r format(round(player_data$points/player_data$games_played,2), nsmall=2)`</td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="num">`r format(round(player_data$goals/player_data$games_played*player_data$league_multiplier*82,2), nsmall=2)`</td>
      <td class="num">`r format(round(player_data$assists/player_data$games_played*player_data$league_multiplier*82,2), nsmall=2)`</td>
      <td class="num">`r format(round(player_data$points/player_data$games_played*player_data$league_multiplier*82,2), nsmall=2)`</td>
    </tr>
    <tr>
...
<div class="biotext">
  ...
  <h5 class="bio" style="margin-top: -4%">AGE -- `r paste(format(round(player_data$age,2), nsmall=2), "YEARS", sep = " ")`<h5>
  </div>
