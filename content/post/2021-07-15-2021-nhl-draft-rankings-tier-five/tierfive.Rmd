---
title: '2021 NHL Draft Rankings -- Tier Five'
author: '@DraftLook'
date: '2021-07-15'
slug: tierfive
categories:
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\OOlausson.html")
```
...
info <- subset(info, player_name == "Oskar Olausson")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\BOthmann.html")
```
...
info <- subset(info, player_name == "Brennan Othmann")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\DChayka.html")
```
...
info <- subset(info, player_name == "Daniil Chayka")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\ARaty.html")
```
...
info <- subset(info, player_name == "Aatu Raty")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\SSalminen.html")
```
...
info <- subset(info, player_name == "Samu Salminen")
```
