---
title: '2021 NHL Draft Rankings -- Tier Three'
author: '@DraftLook'
date: '2021-07-15'
slug: tierthree
categories:
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\FPinelli.html")
```
...
info <- subset(info, player_name == "Francesco Pinelli")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\XBourgault.html")
```
...
info <- subset(info, player_name == "Xavier Bourgault")
```
...
<div class = "nav">
<br>
[Take me to Tier Four!](/post/tierfour/)
</div>