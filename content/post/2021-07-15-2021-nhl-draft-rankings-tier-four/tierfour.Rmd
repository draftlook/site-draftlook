---
title: '2021 NHL Draft Rankings -- Tier Four'
author: '@DraftLook'
date: '2021-07-15'
slug: tierfour
categories:
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\SRobertsson.html")
```
...
info <- subset(info, player_name == "Simon Robertsson")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\CCeulemans.html")
```
...
info <- subset(info, player_name == "Corson Ceulemans")
```
...
**26. Logan Stankoven, RHC/RW, Kamloops Blazers (WHL)**
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\ZL'Heureux.html")
```
...
info <- subset(info, player_name == "Zachary L'Heureux")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\BJohnson.html")
```
...
info <- subset(info, player_name == "Brent Johnson")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\AMartino.html")
```
...
info <- subset(info, player_name == "Aryton Martino")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\AOlsson.html")
```
...
info <- subset(info, player_name == "Anton Olsson")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\MMcTavish.html")
```
...
info <- subset(info, player_name == "Mason McTavish")
```
...
<div class = "nav">
<br>
[Take me to Tier Five!](/post/tierfive/)
</div>