...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\FSvechkov.html")
```
...
info <- subset(info, player_name == "Fyodor Svechkov")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\OZellweger.html")
```
...
info <- subset(info, player_name == "Olen Zellweger")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\RKidney.html")
```
...
info <- subset(info, player_name == "Riley Kidney")
```
...
```{r echo=FALSE }
htmltools::includeHTML("C:\\Users\\ellis\\Desktop\\site-draftlook\\Cards\\MSamoskevich.html")
```
...
info <- subset(info, player_name == "Matthew Samoskevich")
```
